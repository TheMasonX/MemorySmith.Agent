<#
.SYNOPSIS
Stops and uninstalls the MemorySmith World Wiki (TestWorld) Windows service.
#>
[CmdletBinding()]
param(
...
# Stop first
& (Join-Path $PSScriptRoot "Stop-WorldWikiService.ps1") -Quiet -ServiceName $ServiceName
