...
**Current version: v0.23.0** | **Sprint 23 complete** | CI green
...
| [Phase 4 Tasks](Tasks/phase4-tasks.md) | Vision & adaptive execution — complete |
| [Phase 4b Tasks](Tasks/phase4b-tasks.md) | Code audit findings — complete |
...
**Sprint 23 complete** — v0.23.0 — 200+ tests, CI green.

**Delivered across Sprints 1–23:**
- ✅ Full HTN planner with goal decomposers (Build, Gather, SurviveNight)
- ✅ MemorySmith memory integration (Agent KB + World KB dual gateway)
- ✅ In-game chat interpretation (CraftRegex + LLM fallback, 10s timeout)
- ✅ Serilog structured logging (file + console, ms precision)
- ✅ Replan governor (stall detection, auto-recovery)
- ✅ Agent journal (bounded 1000 entries, 11 event types)
- ✅ World model (predict/reconcile/uncertainty for 9 tools)
- ✅ Damage interrupt (real-time, per-goal thresholds, cooldowns)
- ✅ Tool validation (JSON Schema against InputSchema)
- ✅ Inventory freshness gate, health-critical monitoring

Next: **Sprint 24** — integration test for TryInterruptOnDamage, GatherGoalDecomposer TargetCount, TimeProvider abstraction, IWorldObservationGateway design.
